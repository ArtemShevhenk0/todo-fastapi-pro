...
from app.config import SECRET_KEY, ALGORITHM #настройки
...
def create_access_token(data:dict):
    ...
    token = jwt.encode(to_encode, SECRET_KEY, algorithm=ALGORITHM)# 4. Кодируем всё это через jwt.encode и возвращаем результат
    return token
